...
In this exercise, you will create an animated explosion and instance it whenever a bullet collides or one of the other elements dies. You will cause the large asteroid to become several small asteroids when hit. You will create an enemy that fires bullets at the player.

The expectations for this exercise are that you will

 - [ ] Fork and clone this repository
 - [ ] Import the project into Godot
 - [ ] Create an Explosing scene: set up the animation and cause it to delete itself when the animation is completed
 - [ ] Instance the explosion when the bullet collides or the player dies
 - [ ] Create the Asteroid_Small scene. Instance three small asteroids when the large asteroid is destroyed
 - [ ] Create an enemy bullet scene
 - [ ] Create an enemy scene. Cause the enemy to target the player and shoot bullets at it
 - [ ] Animate the movement of the enemy across the screen
 - [ ] Instance the explosion when the enemy or asteroids are destroyed or when the enemy bullet collides
 - [ ] Respawn the player if it is destroyed
 - [ ] Edit the LICENSE and README.md
 - [ ] Commit and push your changes back to GitHub. Turn in the URL of your repository on Canvas.

## Instructions

Fork the repository. When that process has completed, make sure that the top of the repository reads `[your username]/Exercise-02c-Explosions-and-Enemy`. *Edit the LICENSE and replace BL-MSCH-C220 with your full name.* Commit your changes.
